...
class InsertProductosFinalesRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'productos_finales.*.subprograma' => 'required|string|max:500',
            'productos_finales.*.proyecto' => 'required|string|max:500',
            'productos_finales.*.actividad' => 'required|string|max:500',
            'productos_finales.*.costo_total_aproximado' => 'required|numeric|min:0',
            'productos_finales.*.nombre_obra' => 'required|string|max:500',
