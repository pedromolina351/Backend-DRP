...
class InsertProductosFinalesRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'productos_finales.*.fecha_inicio' => 'required|date',
            'productos_finales.*.fecha_fin' => 'required|date',
            'productos_finales.*.responsable' => 'required|string',
            'productos_finales.*.medio_verificacion' => 'required|string',
