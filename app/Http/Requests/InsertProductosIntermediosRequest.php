     ...
     */
     ...
     public function rules()
     {
         return [
            ...
            'productos_intermedios.*.fecha_inicio' => 'required|date',
            'productos_intermedios.*.fecha_fin' => 'required|date',
            'productos_intermedios.*.responsable' => 'required|string',
            'productos_intermedios.*.medio_verificacion' => 'required|string',
